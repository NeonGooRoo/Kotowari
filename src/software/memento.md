...
В открывшуюся папочку перенесите содержимое [данного архива](https://drive.google.com/file/d/1zLugi2OhNDSC3pDcgVFlRKypSTbRbNOY/view?usp=sharing). Перезагрузите программу, чтобы проверить, что все работает, наведитесь на **settings** - **profile**, там должен быть выбран профиль _NeonGoo.Ru_.
