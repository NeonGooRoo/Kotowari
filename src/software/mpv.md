...
Вы используете не основной профиль Anki, измените настройки соответственно тому как написано в разделе [**Установка**](https://kotowari.rumpv.html#%D1%83%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0)