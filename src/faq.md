...
Могут. Уверен _Майн Кампф_ был популярен в Германии в 1938. Уверен учебники по биологии 1971 года были популярны в 1971 году, не значит что там все было правильно. Критически подходите к выбору подхода, на который вы будете тратить сотни часов.
...
Через много лет лет языка. Я видел цифру в _4 года по 6 часов в день_ на [TheMoeWay](https://learnjapanese.moe/faq/), но мне кажется в этом нет смысла. Свободность не наступает в один момент, это ОЧЕНЬ медленный выход с плато и вам уде будет все равно. Просто учите и пытайтесь получить удовольствие здесь и сейчас, а не ждите момента когда "наконец можно почиллить и получать кайф".
